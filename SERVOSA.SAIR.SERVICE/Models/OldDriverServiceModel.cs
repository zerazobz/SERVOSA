...
namespace SERVOSA.SAIR.SERVICE.Models
{
    public class OldDriverServiceModel
    {
        ...
        public static void ToViewModel(OldDriverModel model, ref OldDriverServiceModel viewModel)
        {
            if (model != null)
        ...
        public static void ToModel(OldDriverServiceModel viewModel, ref OldDriverModel model)
        {
            if (viewModel != null)
                model = new OldDriverModel()
                {
