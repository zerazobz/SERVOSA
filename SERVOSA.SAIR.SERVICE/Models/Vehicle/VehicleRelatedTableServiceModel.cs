...
namespace SERVOSA.SAIR.SERVICE.Models.Vehicle
{
    public class VehicleRelatedTableServiceModel
    {
        ...
        public static void ToDataModel(VehicleRelatedTableServiceModel serviceModel, ref RelatedTableToVehicleModel dataModel)
        {
            if (serviceModel != null)
                dataModel = new RelatedTableToVehicleModel()
                {
        ...
        public static void ToServiceModel(RelatedTableToVehicleModel dataModel, ref VehicleRelatedTableServiceModel serviceModel)
        {
            if (dataModel != null)
