...
namespace SERVOSA.SAIR.WEB.Controllers
{
    public partial class DriverVariableTasksController
    {
        ...
        {
            public const string DriverCreateTable = "DriverCreateTable";
            public const string DriverCreateColumn = "DriverCreateColumn";
        }


        static readonly ActionParamsClass_DriverCreateTable s_params_DriverCreateTable = new ActionParamsClass_DriverCreateTable();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_DriverCreateTable DriverCreateTableParams { get { return s_params_DriverCreateTable; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_DriverCreateTable
        {
    ...
    public partial class T4MVC_DriverVariableTasksController : SERVOSA.SAIR.WEB.Controllers.DriverVariableTasksController
    {
        ...
        [NonAction]
        partial void DriverCreateTableOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult DriverCreateTable()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.DriverCreateTable);
            DriverCreateTableOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void DriverCreateTableOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, SERVOSA.SAIR.SERVICE.Models.DriverTableServiceModel viewModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult DriverCreateTable(SERVOSA.SAIR.SERVICE.Models.DriverTableServiceModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.DriverCreateTable);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
            DriverCreateTableOverride(callInfo, viewModel);
            return callInfo;
        }
